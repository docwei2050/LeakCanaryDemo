...
import static com.docwei.leakcanarydemo.analyzer.InternalUtils.HUAWEI;
import static com.docwei.leakcanarydemo.analyzer.InternalUtils.LENOVO;
import static com.docwei.leakcanarydemo.analyzer.InternalUtils.LG;
import static com.docwei.leakcanarydemo.analyzer.InternalUtils.MEIZU;
import static com.docwei.leakcanarydemo.analyzer.InternalUtils.MOTOROLA;
import static com.docwei.leakcanarydemo.analyzer.InternalUtils.NVIDIA;
import static com.docwei.leakcanarydemo.analyzer.InternalUtils.SAMSUNG;
import static com.docwei.leakcanarydemo.analyzer.InternalUtils.VIVO;
...
public enum AndroidExcludedRefs {
  ...
  ExcludedRefs.Builder createAndroidDefaults() {
    return createBuilder(
        EnumSet.of(SOFT_REFERENCES, FINALIZER_WATCHDOG_DAEMON, MAIN,
            EVENT_RECEIVER__MMESSAGE_QUEUE));
  }
